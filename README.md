...
- Build date: 2016-11-25T15:33:48.129-08:00
...
*DataHubApi.DataApi* | [**getCSVData**](docs/DataApi.md#getCSVData) | **GET** /data/{elementcode}/csv | 
...
*DataHubApi.ElementApi* | [**addElement**](docs/ElementApi.md#addElement) | **POST** /element/{elementcode} | Create a new open element
...
*DataHubApi.ReleaseApi* | [**addRelease**](docs/ReleaseApi.md#addRelease) | **POST** /release/{releasecode} | Create a new open release
...
*DataHubApi.ReleaseApi* | [**getReleases**](docs/ReleaseApi.md#getReleases) | **GET** /releases/{repocode} | Get releases for a repository
*DataHubApi.ReleaseApi* | [**publishRelease**](docs/ReleaseApi.md#publishRelease) | **GET** /release/publish/{releasecode} | Publish a release
*DataHubApi.ReleaseApi* | [**updateRelease**](docs/ReleaseApi.md#updateRelease) | **PUT** /release/{releasecode} | Update a release
...
*DataHubApi.SubscriptionApi* | [**createSubscription**](docs/SubscriptionApi.md#createSubscription) | **POST** /subscription/{repocode}/{usercode} | Create a new subscription
*DataHubApi.SubscriptionApi* | [**getUserSubscriptions**](docs/SubscriptionApi.md#getUserSubscriptions) | **GET** /subs | Get the repositories that the current user is subscribed to
...
## Documentation for Models
 ...
 - [DataHubApi.RepositoryView](docs/RepositoryView.md)
