...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MimirDataHubApi.DefaultApi = factory(root.MimirDataHubApi.ApiClient, root.MimirDataHubApi.Invoice);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/DefaultApi~addSubscriptionToInvoiceCallback
     ...
     * @param {module:api/DefaultApi~addSubscriptionToInvoiceCallback} callback The callback function, accepting three arguments: error, data, response
