...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} apiKey The user API key for this operation
     * @param {String} repocode The code of the repo to add (must be part of the user&#39;s code)
     ...
     */
    this.addRepository = function(apiKey, repocode, body, callback) {
      var postBody = body;

      // verify the required parameter 'apiKey' is set
      if (apiKey == undefined || apiKey == null) {
        throw "Missing the required parameter 'apiKey' when calling addRepository";
      }

      // verify the required parameter 'repocode' is set
      if (repocode == undefined || repocode == null) {
        throw "Missing the required parameter 'repocode' when calling addRepository";
      }
     ...
     * data is of type: {@link module:model/GeneralStatus}
     */
    this.deleteRepository = function(apiKey, repocode, callback) {
      var postBody = null;

      // verify the required parameter 'apiKey' is set
      if (apiKey == undefined || apiKey == null) {
        throw "Missing the required parameter 'apiKey' when calling deleteRepository";
      }
     ...
     */
    this.getRepositoryByCode = function(apiKey, repocode, callback) {
      var postBody = null;

      // verify the required parameter 'apiKey' is set
      if (apiKey == undefined || apiKey == null) {
        throw "Missing the required parameter 'apiKey' when calling getRepositoryByCode";
      }
