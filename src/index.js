...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BlockId', 'model/DataElement', 'model/DataElementBlock', 'model/DataSet', 'model/DataSetRelease', 'model/DataSetView', 'model/GeneralError', 'model/User', 'model/UserProfile', 'model/UserTokens', 'api/AdminApi', 'api/BlockApi', 'api/DatasetApi', 'api/ElementApi', 'api/ReleaseApi', 'api/UserApi', 'api/ViewApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/BlockId'), require('./model/DataElement'), require('./model/DataElementBlock'), require('./model/DataSet'), require('./model/DataSetRelease'), require('./model/DataSetView'), require('./model/GeneralError'), require('./model/User'), require('./model/UserProfile'), require('./model/UserTokens'), require('./api/AdminApi'), require('./api/BlockApi'), require('./api/DatasetApi'), require('./api/ElementApi'), require('./api/ReleaseApi'), require('./api/UserApi'), require('./api/ViewApi'));
  }
}(function(ApiClient, BlockId, DataElement, DataElementBlock, DataSet, DataSetRelease, DataSetView, GeneralError, User, UserProfile, UserTokens, AdminApi, BlockApi, DatasetApi, ElementApi, ReleaseApi, UserApi, ViewApi) {
  'use strict';
