...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DataElement', 'model/DataSet', 'model/DataSetRelease', 'model/DataSetView', 'model/GeneralError', 'model/User', 'model/UserProfile', 'model/UserTokens', 'api/AdminApi', 'api/BlockApi', 'api/DatasetApi', 'api/ElementApi', 'api/ReleaseApi', 'api/UserApi', 'api/ViewApi'], factory);
...
}(function(ApiClient, DataElement, DataSet, DataSetRelease, DataSetView, GeneralError, User, UserProfile, UserTokens, AdminApi, BlockApi, DatasetApi, ElementApi, ReleaseApi, UserApi, ViewApi) {
  'use strict';
