...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BlockId', 'model/DataElement', 'model/DataElementBlock', 'model/DataSet', 'model/DataSetRelease', 'model/User', 'model/UserProfile', 'api/AdminApi', 'api/BlockApi', 'api/DatasetApi', 'api/ElementApi', 'api/ReleaseApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/BlockId'), require('./model/DataElement'), require('./model/DataElementBlock'), require('./model/DataSet'), require('./model/DataSetRelease'), require('./model/User'), require('./model/UserProfile'), require('./api/AdminApi'), require('./api/BlockApi'), require('./api/DatasetApi'), require('./api/ElementApi'), require('./api/ReleaseApi'));
  }
}(function(ApiClient, BlockId, DataElement, DataElementBlock, DataSet, DataSetRelease, User, UserProfile, AdminApi, BlockApi, DatasetApi, ElementApi, ReleaseApi) {
  'use strict';
