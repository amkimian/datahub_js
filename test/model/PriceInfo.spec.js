...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MimirDataHubApi.PriceInfo();
  });
  ...
  describe('PriceInfo', function() {
    it('should create an instance of PriceInfo', function() {
      // uncomment below and update the code to test PriceInfo
      //var instane = new MimirDataHubApi.PriceInfo();
      //expect(instance).to.be.a(MimirDataHubApi.PriceInfo);
    });
