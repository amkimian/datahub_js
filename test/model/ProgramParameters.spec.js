...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataHubApi.ProgramParameters();
  });
  ...
  describe('ProgramParameters', function() {
    it('should create an instance of ProgramParameters', function() {
      // uncomment below and update the code to test ProgramParameters
      //var instane = new DataHubApi.ProgramParameters();
      //expect(instance).to.be.a(DataHubApi.ProgramParameters);
    });
