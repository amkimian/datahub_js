...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MimirDataHubApi.SchemeField();
  });
  ...
  describe('SchemeField', function() {
    it('should create an instance of SchemeField', function() {
      // uncomment below and update the code to test SchemeField
      //var instane = new MimirDataHubApi.SchemeField();
      //expect(instance).to.be.a(MimirDataHubApi.SchemeField);
    });
